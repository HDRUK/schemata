...
| title      | is_list   | is_optional   | required   | type                                                                                                         |
|:-----------|:----------|:--------------|:-----------|:-------------------------------------------------------------------------------------------------------------|
| Datasetype | False     | True          | True       | ["DatasetType[{'anyOf': [{'maxLength': 100, 'minLength': 2, 'type': 'string'}, {'type': 'null'}]}]", 'null'] |
...
| title                           | is_list   | is_optional   | required   | type                                                                                 |
|:--------------------------------|:----------|:--------------|:-----------|:-------------------------------------------------------------------------------------|
| Access/governance requirementss | True      | True          | False      | ["AccessService['TRE/SDE','Direct access','Open access','Varies based on project']"] |
